...
void main() async {
  // Ensure that Flutter widget binding is initialized before Hive or DI setup
  WidgetsFlutterBinding.ensureInitialized();
  
  // Initialize Hive CE (Community Edition) with default storage path
  await Hive.initFlutter();
  
  // Register Binary Adapters for Hive storage
  // Note: These are generated by hive_ce_generator
  Hive.registerAdapter(SourceResponseAdapter());
  Hive.registerAdapter(SourceAdapter());
  Hive.registerAdapter(NewsResponseAdapter());
  Hive.registerAdapter(ArticlesAdapter());

  // Prefetch/Open the high-level cache box (optional but stays open)
  await Hive.openBox('news_cache');

  // Initialize Injectable/GetIt Dependency Injection
